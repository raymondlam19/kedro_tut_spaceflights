...
# kedro_tut_spaceflights documentation build
...
from kedro_tut_spaceflights import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_tut_spaceflights"
author = "Kedro"
...
htmlhelp_basename = "kedro_tut_spaceflightsdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_tut_spaceflights.tex",
        "kedro_tut_spaceflights Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_tut_spaceflights",
        "Project kedro_tut_spaceflights codebase.",
        "Data-Science",
    )
]
